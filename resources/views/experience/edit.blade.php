...
@section('content')
    <div class="p-20 flex-col  justify-center container text-white">
        ...
        <form class="flex-col w-11/12 ml-auto mr-auto justify-center" action="{{ route('experience.update', $experience) }}"
            ...
            <label for="achievement" class="block mb-2 text-sm font-medium text-white">
                <p> Achievement:</p>
                <textarea name="achievement" id="achievement" cols="55" rows="4" class="text-black">{{ $experience->achievement }}</textarea>
            </label>
